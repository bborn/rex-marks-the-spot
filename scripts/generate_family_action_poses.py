...
CHARACTER_REFS = {
    "gabe": """Gabe (Father, late 30s): Athletic dad-bod build, dark brown hair with hints of gray,
short stubble beard, rectangular glasses, warm brown eyes. Wearing black tuxedo (now torn and disheveled).""",

    "nina": """Nina (Mother, late 30s): Warm and elegant, shoulder-length wavy dark brown hair,
striking hazel-green eyes, athletic build. Wearing elegant black cocktail dress (now torn/dirty).""",

    "mia": """Mia (9-year-old daughter): Brown hair in ponytail with turquoise scrunchie,
big expressive hazel eyes, determined expression, wearing purple star t-shirt and denim shorts.""",

    "leo": """Leo (5-year-old son): Messy blonde/light brown hair, big round innocent blue eyes,
...
Scene: Nina in fierce protective mama-bear stance, body coiled and ready to strike.
Her cocktail dress is torn at the hem, heels kicked off (barefoot), hair wild and loose.
Expression: intense protective fury, eyes blazing with maternal fire.
One hand raised in a stopping gesture, other arm pulled back ready.
...
Shows both elegance and primal protective power."""
    },
    {
...
Shows sibling bond and Mia's protective older sister nature."""
    },
    {
        ...
        "prompt": f"""Family group pose. {CHARACTER_REFS['gabe']} {CHARACTER_REFS['nina']} {CHARACTER_REFS['mia']} {CHARACTER_REFS['leo']}

Scene: All four family members huddled together in fear, backs against something unseen.
Gabe and Nina on the outside creating a protective shell around the kids.
Mia and Leo in the center - Leo hiding his face in Mia's shoulder, Mia holding him tight.
Parents' hands interlinked behind the kids, creating unity.
All looking in the same direction at something frightening, wide eyes.
Everyone's clothes disheveled from their adventure.
Background: dark shadows suggesting threat, small light source on the family.
Emotional core: fear but also unshakeable family unity.
Composition: tight, intimate grouping showing family bond."""
    },
    {
...
Scene: The family in joyful celebration after surviving their adventure.
Gabe lifting Leo up high, both laughing with pure joy.
Nina embracing Mia, both with tears of relief and huge smiles.
The family forming a natural circle of love and connection.
All still in their battle-worn clothes (torn tuxedo, damaged dress, dirty kids' clothes).
But everyone is GLOWING with relief and happiness.
Background: warm golden light, suggesting sunrise or hope.
Dynamic poses: movement and energy, everyone animated with joy.
Captures the emotional payoff of surviving together as a family.
Pure Pixar emotional moment."""
    },
]
