...
professional animation production quality""",
    ...
    "swamp": {
        "giant_ferns": """Pixar 3D animation style environment concept art,
prehistoric swamp environment featuring towering giant ferns,
massive tree ferns reaching 40 feet tall with graceful arching fronds,
dense layered canopy of fern varieties from floor to canopy,
coiled fiddleheads unfurling at various stages,
shafts of golden-green dappled light filtering through frond layers,
prehistoric atmosphere with humid misty air,
small colorful insects hovering between fronds,
family-friendly magical ancient forest feeling,
lush overwhelming botanical beauty,
professional animation production quality, cinematic composition""",

        "bioluminescent_mushrooms": """Pixar 3D animation style environment concept art,
enchanted prehistoric swamp at twilight with bioluminescent mushrooms,
clusters of glowing cyan and purple mushrooms on fallen logs,
soft magical blue-green glow reflecting on dark swamp water,
variety of luminescent fungal shapes and sizes,
larger mushrooms with spotted caps glowing warmly,
tiny fairy-like mushrooms creating paths of light,
mysterious but welcoming magical atmosphere,
fireflies complementing the mushroom glow,
whimsical family-friendly enchanted forest feeling,
professional animation production quality, dreamy lighting""",

        "friendly_carnivorous_plants": """Pixar 3D animation style environment concept art,
whimsical prehistoric swamp with friendly cartoon carnivorous plants,
oversized pitcher plants with cute faces and googly expressions,
chubby Venus flytraps that look more curious than dangerous,
sundews with sparkling dew drops like jeweled tentacles,
plants with expressive leaf-mouths appearing to smile,
colorful magenta pink and lime green carnivorous varieties,
small friendly insects buzzing around unbothered,
family-friendly comedic atmosphere,
cartoon plants that kids would find adorable not scary,
professional animation production quality, playful composition""",

        "hanging_vines": """Pixar 3D animation style environment concept art,
prehistoric swamp interior with dramatic hanging vines,
thick woody vines draped like natural curtains between ancient trees,
delicate flowering vines with colorful blossoms,
rope-like vines perfect for swinging on,
vine bridges naturally formed between tree platforms,
morning mist weaving through the hanging vegetation,
shafts of warm sunlight creating magical atmosphere,
small creatures climbing and playing on vines,
inviting adventure playground feeling for kids,
professional animation production quality, vertical composition""",

        "ancient_trees": """Pixar 3D animation style environment concept art,
prehistoric swamp dominated by massive ancient trees,
gnarled thick trunk with character-filled bark patterns,
roots forming natural archways and hidden spaces,
enormous tree with hollow interior like a natural room,
moss and lichen covering ancient bark in soft textures,
branches reaching out like welcoming arms,
golden amber sap glowing on trunk,
sense of wise ancient presence in the trees,
friendly protective ancient guardian feeling,
professional animation production quality, majestic scale""",

        "swamp_overview": """Pixar 3D animation style environment concept art,
panoramic view of magical prehistoric swamp ecosystem,
combining giant ferns ancient trees hanging vines,
patches of bioluminescent mushrooms glowing near water,
friendly carnivorous plants dotting the shoreline,
misty atmosphere with golden-green lighting,
shallow murky water with lily pads and reflections,
pterodactyl silhouette in distant amber sky,
welcoming magical prehistoric paradise,
perfect background plate for animated film,
professional animation production quality, wide establishing shot""",
    },
