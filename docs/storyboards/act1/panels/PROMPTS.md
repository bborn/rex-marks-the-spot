# Act 1 Storyboard Panel - AI Generation Prompts
...
- **Jenny (Babysitter, ~15):** Dark brown curly hair in messy ponytail, brown skin, coral pink hoodie, gray leggings, white sneakers, always on phone

---

## Scene 1: INT. HOME - EVENING (9 panels)

### Panel 1A (scene-01-panel-01.png)
**Shot:** Wide Establishing
**Prompt:**
```
Storyboard panel, wide establishing shot, warm suburban living room,
...
### Panel 1B (scene-01-panel-02.png)
**Shot:** Medium - Leo
**Prompt:**
```
Storyboard panel, medium shot, cute 5-year-old boy on couch,
...
### Panel 1C (scene-01-panel-03.png)
**Shot:** Tracking - Nina
**Prompt:**
```
Storyboard panel, medium tracking shot, elegant mother late 30s,
...
### Panel 1D (scene-01-panel-04.png)
**Shot:** Two-Shot - Gabe and Nina
**Prompt:**
```
Storyboard panel, two-shot medium, married couple in formal wear,
...
### Panel 1E (scene-01-panel-05.png)
**Shot:** Insert - Jenny
**Prompt:**
```
Storyboard panel, close-up insert, teenage babysitter dark brown curly hair messy ponytail, brown skin, coral pink hoodie,
...
### Panel 1F (scene-01-panel-06.png)
**Shot:** Close-up - TV Flickering
**Prompt:**
```
Storyboard panel, close-up, TV screen filling frame,
...
### Panel 1G (scene-01-panel-07.png)
**Shot:** Over-the-Shoulder - Kids Watching
**Prompt:**
```
Storyboard panel, over-the-shoulder shot from behind children,
...
### Panel 1H (scene-01-panel-08.png)
**Shot:** Close-up - Mia
**Prompt:**
```
Storyboard panel, close-up emotional, 8-year-old girl face,
...
### Panel 1I (scene-01-panel-09.png)
**Shot:** Close-up - Gabe Hesitates
**Prompt:**
```
Storyboard panel, close-up to two-shot, father with glasses showing conflict,
...
### Panel 2A (scene-02-panel-01.png)
**Shot:** Wide - House Exterior
**Prompt:**
```
Storyboard panel, wide establishing exterior, suburban house at night,
...
### Panel 2B (scene-02-panel-02.png)
**Shot:** Tracking - Parents Rush to Car
**Prompt:**
```
Storyboard panel, medium tracking shot, formal couple rushing through rain,
...
### Panel 2C (scene-02-panel-03.png)
**Shot:** Low Angle - Lightning Sky
**Prompt:**
```
Storyboard panel, low angle wide shot looking up at sky,
...
### Panel 3A (scene-03-panel-01.png)
**Shot:** Two-Shot - Driving
**Prompt:**
```
Storyboard panel, two-shot car interior from dashboard,
...
### Panel 3B (scene-03-panel-02.png)
**Shot:** Insert - Phone Screen
**Prompt:**
```
Storyboard panel, close-up insert, smartphone screen in dark car,
...
### Panel 3C (scene-03-panel-03.png)
**Shot:** POV - Windshield View
**Prompt:**
```
Storyboard panel, POV through windshield, driver's view of road,
...
### Panel 3D (scene-03-panel-04.png)
**Shot:** Close-up - Nina
**Prompt:**
```
Storyboard panel, close-up, elegant wife in profile or three-quarter view,
...
### Panel 4A (scene-04-panel-01.png)
**Shot:** Wide - Living Room
**Prompt:**
```
Storyboard panel, wide shot, peaceful living room same as scene 1,
...
### Panel 4B (scene-04-panel-02.png)
**Shot:** Insert - Jenny Texting
**Prompt:**
```
Storyboard panel, close-up insert, teenage babysitter hands and phone,
...
### Panel 4C (scene-04-panel-03.png)
**Shot:** Insert - Hidden Phone Buzzing
**Prompt:**
```
Storyboard panel, close-up insert, smartphone partially hidden under cushion,
...
### Panel 5A (scene-05-panel-01.png)
**Shot:** POV - Time Warp Opens
**Prompt:**
```
Storyboard panel, POV through windshield, MAJOR VFX moment,
...
### Panel 5B (scene-05-panel-02.png)
**Shot:** Interior - Terror Reaction
**Prompt:**
```
Storyboard panel, medium two-shot interior car, MAJOR VFX,
...
### Panel 5C (scene-05-panel-03.png)
**Shot:** Wide - Car Enters Portal
**Prompt:**
```
Storyboard panel, wide exterior shot, spectacular VFX moment,
...
### Panel 5D (scene-05-panel-04.png)
**Shot:** Close-up - Vortex Consuming Car
**Prompt:**
```
Storyboard panel, close-up on vortex edge, VFX detail,
...
### Panel 6A (scene-06-panel-01.png)
**Shot:** Wide - TV Explodes
**Prompt:**
```
Storyboard panel, wide living room shot, supernatural moment,
...
### Panel 6B (scene-06-panel-02.png)
**Shot:** Reaction - All Three Startled
**Prompt:**
```
Storyboard panel, medium group shot, three startled faces,
...
### Panel 6C (scene-06-panel-03.png)
**Shot:** Low Light - Atmosphere Shift
**Prompt:**
```
Storyboard panel, wide low light, eerie atmosphere,
...
### Panel 6D (scene-06-panel-04.png)
**Shot:** Insert - Nina's Phone Glowing
**Prompt:**
```
Storyboard panel, close-up insert, supernatural phone glow,
...
### Panel 7A (scene-07-panel-01.png)
**Shot:** Close-up - Nina Wakes
**Prompt:**
```
Storyboard panel, close-up, woman's face eyes closed then opening,
...
### Panel 7B (scene-07-panel-02.png)
**Shot:** POV - Trashed Car Interior
**Prompt:**
```
Storyboard panel, POV from passenger position scanning car,
...
### Panel 7C (scene-07-panel-03.png)
**Shot:** Insert - Toy Dinosaur on Dashboard
**Prompt:**
```
Storyboard panel, close-up insert, plastic T-Rex toy on dashboard,
...
### Panel 7D (scene-07-panel-04.png)
**Shot:** Two-Shot - Nina Rouses Gabe
**Prompt:**
```
Storyboard panel, medium two-shot, wife reaching to wake husband,
...
### Panel 7E (scene-07-panel-05.png)
**Shot:** POV - Nina Looking Out Window
**Prompt:**
```
Storyboard panel, POV from car looking through window,
...
### Panel 7F (scene-07-panel-06.png)
**Shot:** Wide Through Window - Swamp Reveal
**Prompt:**
```
Storyboard panel, wide landscape shot through car window,
...
### Panel 8A (scene-08-panel-01.png)
**Shot:** Wide - Parents Emerge
**Prompt:**
```
Storyboard panel, wide establishing shot, crane down composition,
...
### Panel 8B (scene-08-panel-02.png)
**Shot:** POV - Exotic Plants
**Prompt:**
```
Storyboard panel, POV handheld exploring, sense of wonder,
...
### Panel 8C (scene-08-panel-03.png)
**Shot:** Medium - Time Warp and Weird Creature
**Prompt:**
```
Storyboard panel, medium shot, nearly-closed TIME WARP,
...
### Panel 8D (scene-08-panel-04.png)
**Shot:** Close-up - Ground Rumble
**Prompt:**
```
Storyboard panel, close-up ground level, Jurassic Park homage,
...
### Panel 8E (scene-08-panel-05.png)
**Shot:** Reaction - Weird Creature Flees
**Prompt:**
```
Storyboard panel, medium shot, cute creature FREEZING in fear,
...
### Panel 8F (scene-08-panel-06.png)
**Shot:** Wide - T-REX APPEARS **HERO SHOT**
**Prompt:**
```
Storyboard panel, wide HERO SHOT, T-REX REVEAL, MAJOR VFX,
...
### Panel 8G (scene-08-panel-07.png)
**Shot:** Close-up - T-Rex Head
**Prompt:**
```
Storyboard panel, close-up, T-Rex head filling frame,
...
### Panel 8H (scene-08-panel-08.png)
**Shot:** Low Angle - T-Rex Smashes Car
**Prompt:**
```
Storyboard panel, low angle, T-Rex destroying car,
...
### Panel 8I (scene-08-panel-09.png)
**Shot:** Tracking - Parents Flee
**Prompt:**
```
Storyboard panel, medium tracking shot, couple running for lives,
...
### Panel 9A (scene-09-panel-01.png)
**Shot:** Steadicam - Chase Through Ferns
**Prompt:**
```
Storyboard panel, steadicam chase shot from behind,
...
### Panel 9B (scene-09-panel-02.png)
**Shot:** POV - Looking Back at Destruction
**Prompt:**
```
Storyboard panel, POV over shoulder looking back while running,
...
### Panel 9C (scene-09-panel-03.png)
**Shot:** Wide - T-Rex Crashes Through
**Prompt:**
```
Storyboard panel, wide shot, T-Rex CRASHING through jungle,
...
### Panel 9D (scene-09-panel-04.png)
**Shot:** Medium - Second Dinosaur Blocks Path
**Prompt:**
```
Storyboard panel, medium shot shock cut, NEW THREAT,
...
### Panel 9E (scene-09-panel-05.png)
**Shot:** Two-Shot - Running and Arguing
**Prompt:**
```
Storyboard panel, medium tracking alongside, comedy in chaos,
...
### Panel 9F (scene-09-panel-06.png)
**Shot:** POV - Cave Spotted
**Prompt:**
```
Storyboard panel, POV quick pan locking onto salvation,
...
### Panel 9G (scene-09-panel-07.png)
**Shot:** Tracking - Slide Into Cave
**Prompt:**
```
Storyboard panel, tracking into cave entrance,
...
### Panel 10A (scene-10-panel-01.png)
**Shot:** Wide - Cave Interior
**Prompt:**
```
Storyboard panel, wide cave interior establishing,
...
### Panel 10B (scene-10-panel-02.png)
**Shot:** Insert - T-Rex Claws at Entrance
**Prompt:**
```
Storyboard panel, close-up insert, T-Rex claws at cave entrance,
...
### Panel 10C (scene-10-panel-03.png)
**Shot:** Two-Shot - Parents Huddle
**Prompt:**
```
Storyboard panel, medium two-shot, intimate framing,
...
### Panel 10D (scene-10-panel-04.png)
**Shot:** Sound Design Shot - Dinosaur Battle
**Prompt:**
```
Storyboard panel, wide interior reacting to sounds,
...
### Panel 10E (scene-10-panel-05.png)
**Shot:** Close-up - Nina Determined
**Prompt:**
```
Storyboard panel, close-up, wife's face transformation,
...
### Panel 10F (scene-10-panel-06.png)
**Shot:** Two-Shot - Both Realize **EMOTIONAL CLIMAX**
**Prompt:**
```
Storyboard panel, tight two-shot, EMOTIONAL GUT-PUNCH,
...
### Panel 10G (scene-10-panel-07.png)
**Shot:** Insert - Phone in Nina's Hand **END ACT 1**
**Prompt:**
```
Storyboard panel, close-up insert, HOPE OBJECT,
...
### Consistency Tips
1. Use same character descriptions across all panels
2. Track costume deterioration: pristine (1-4) → disheveled (5-6) → survival mode (7-10)
3. Time warp color always bright blue (#0096FF)
4. T-Rex always realistic earth tones, NOT cartoonish
5. Lighting shifts: warm domestic → storm blue → prehistoric golden-green → cave dramatic

### Recommended Workflow
1. Generate all panels for a scene in sequence
2. Use consistent seed/style references within scenes
3. Review for character consistency before moving to next scene
4. Regenerate outliers to match established look

### File Naming
All panels should be saved as:
- `scene-XX-panel-YY.png`
- Where XX is scene number (01-10)
- And YY is panel number within scene (01-09)

Example: `scene-01-panel-01.png` through `scene-10-panel-07.png`
